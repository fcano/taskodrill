...
urlpatterns = [
    ...
    path('tasks/save-task-ordering-goal/', tasks_views.SaveNewOrderingGoal.as_view(), name='save_task_ordering_goal'),
    ...
    path('contexts/context-autocomplete/', tasks_views.ContextAutocomplete.as_view(), name='context-autocomplete'),

...
class TaskFilter(django_filters.FilterSet):
    ...
    creation_datetime_before = django_filters.IsoDateTimeFilter(field_name='creation_datetime', lookup_expr='lte')
    creation_datetime_after = django_filters.IsoDateTimeFilter(field_name='creation_datetime', lookup_expr='gte')
    ...
    class Meta:
        ...
        fields = [
            ...
            'creation_datetime_before', 'creation_datetime_after',
            'context',
        ]
